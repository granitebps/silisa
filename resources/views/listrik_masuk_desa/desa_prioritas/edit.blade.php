...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Edit Desa Prioritas : {{$desa_prioritas->NAMA_DESA}}</div>

                    <div class="card-body">
                        <form action="{{ route('desa_prioritas.update', ['id'=>$desa_prioritas->ID_DESA]) }}" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tertinggal" value="{{$desa_prioritas->desa_prioritas->TERTINGGAL}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Terdepan dan Terluar</label>
                                <input type="text" name="terdepan_dan_terluar" value="{{$desa_prioritas->desa_prioritas->TERDEPAN_DAN_TERLUAR}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">PKSN</label>
                                <input type="text" name="pksn" value="{{$desa_prioritas->desa_prioritas->PKSN}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Lokpri BNPP</label>
                                <input type="text" name="lokpri_bnpp" value="{{$desa_prioritas->desa_prioritas->LOKPRI_BNPP}}" class="form-control">
                            </div>
