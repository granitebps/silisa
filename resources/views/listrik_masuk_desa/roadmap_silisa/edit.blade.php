...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Edit Road Map Silisa : {{$roadmap_silisa->NAMA_DESA}}</div>

                    <div class="card-body">
                        <form action="{{ route('roadmap_silisa.update', ['id'=>$roadmap_silisa->ID_DESA]) }}" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="target_pembangkit" value="{{$roadmap_silisa->roadmap_target->TARGET_PEMBANGKIT}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Target JTM (Kms)</label>
                                <input type="text" name="target_jtm" value="{{$roadmap_silisa->roadmap_target->TARGET_JTM}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Target JTR (Kms)</label>
                                <input type="text" name="target_jtr" value="{{$roadmap_silisa->roadmap_target->TARGET_JTR}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Target Gardu (Unit/kVA)</label>
                                <input type="text" name="target_gardu" value="{{$roadmap_silisa->roadmap_target->TARGET_GARDU}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Target Pelanggan (RT)</label>
                                <input type="text" name="target_pelanggan" value="{{$roadmap_silisa->roadmap_target->TARGET_PELANGGAN}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Keterangan Target</label>
                                <input type="text" name="keterangan_target" value="{{$roadmap_silisa->roadmap_target->KETERANGAN}}" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="realisasi_pembangkit" value="{{$roadmap_silisa->roadmap_realisasi->REALISASI_PEMBANGKIT}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Realisasi JTM (Kms)</label>
                                    <input type="text" name="realisasi_jtm" value="{{$roadmap_silisa->roadmap_realisasi->REALISASI_JTM}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Realisasi JTR (Kms)</label>
                                    <input type="text" name="realisasi_jtr" value="{{$roadmap_silisa->roadmap_realisasi->REALISASI_JTR}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Realisasi Gardu (Unit/kVA)</label>
                                    <input type="text" name="realisasi_gardu" value="{{$roadmap_silisa->roadmap_realisasi->REALISASI_GARDU}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Realisasi Pelanggan (RT)</label>
                                    <input type="text" name="realisasi_pelanggan" value="{{$roadmap_silisa->roadmap_realisasi->REALISASI_PELANGGAN}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Keterangan Realisasi</label>
                                    <input type="text" name="keterangan_realisasi" value="{{$roadmap_silisa->roadmap_realisasi->KETERANGAN}}" class="form-control">
                                </div>
